        ...
        while(tmp!=null){//dibuja toda la lista
            ...
            if(tmp.liga==this.INICIO){ /// EL FINAL TIENE QUE DIBUJAR HACIA EL PRIMERO
                ...
                if(cont==0){
                    ...
                    ctx.beginPath();
                    ctx.moveTo(x+ancho,y+15);
                    ctx.lineTo(x+ancho+20,y+15);
                    ctx.closePath();
                    ctx.stroke();
                    //FLECHA QUE BAJA
                    ctx.beginPath();
                    ctx.moveTo(x+ancho+20,y+15);
                    ctx.lineTo(x+ancho+20,y+55);
                    ctx.closePath();
                    ctx.stroke();
                    //FLECHA QUE A LA IZQUIERDA
                    ctx.beginPath();
                    ctx.moveTo(x+ancho+20,y+55);
                    ...
                    ctx.beginPath();
                    ctx.fillStyle="black";
                    ctx.moveTo(ancho*0.6, alto*1.3);
                    ctx.lineTo(ancho*0.5, alto);
                    ctx.lineTo(ancho*0.4, alto*1.3);
                    ctx.closePath();
                    ctx.fill();
                ...
                if(x>canvas.width-150){//para que baje si supera el limite 
                    ...
                    ctx.beginPath();
                    ctx.moveTo(x+ancho+20,y+15);
                    ctx.lineTo(x+ancho+20,y+40);
                    ctx.closePath();
                    ctx.stroke();
                    ///fecha que va hacia la izquierda
                    ctx.moveTo(x+ancho+20,y+40);
                    ...
                    ctx.moveTo(x+ancho+18,alto*0.3);
                    ctx.lineTo(x+ancho+20+5,alto*0.5);
                    ctx.lineTo(x+ancho+18,alto*0.7);
                    ctx.closePath();
                    ctx.fill();
